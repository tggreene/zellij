...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum ActionType {
        ...
        EjectClient(super::EjectClientAction),
        #[prost(message, tag="96")]
        EjectAllOtherClients(super::EjectAllOtherClientsAction),
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct EjectClientAction {
    #[prost(uint32, tag="1")]
    pub client_id: u32,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct EjectAllOtherClientsAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
